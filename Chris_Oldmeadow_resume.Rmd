...
- <i class="fa fa-envelope"></i> Christopher.oldmeadow@hmri.org.au
...
- Study design |  Bayesian statistics | Big data sets | Clinical Trials | Dashboards | visualising data

- Highly skilled in R, SAS, Stata, Bash, Perl, Python
...
:::
 ...
 Top 5 Publications by citations {data-icon=file}
--------------------------------------------------------------------------------
...
Publications statisstics {data-icon=file}
--------------------------------------------------------------------------------
